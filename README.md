...
> ```
>
> `uvx` equivalent: `uvx --from https://github.com/jgravelle/jcodemunch-mcp/releases/download/v1.108.23/jcodemunch_mcp-1.108.23-py3-none-any.whl jcodemunch-mcp`
>
...
- uses: jgravelle/jcodemunch-mcp/speedreview@v1.108.23
  with:
    groq_api_key: ${{ secrets.GROQ_API_KEY }}
```

For stricter supply-chain hygiene, pin to the tag's commit SHA instead of the
tag itself (`git ls-remote https://github.com/jgravelle/jcodemunch-mcp refs/tags/v1.108.23`).
